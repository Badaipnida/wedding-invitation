...
const translations = {
  ...
  'zh-TW': {
    ...
    'wedding.title': '婚禮資訊',
    'wedding.date': '婚禮時間',
    'wedding.date.value': '2026年3月21日(六)',
    'wedding.ceremony.start': '婚禮開始',
    'wedding.ceremony.time': '下午5時',
    'wedding.ceremony.family': '家人 • 親友入場',
    'wedding.ceremony.family.time': '下午4時 ~',
    'wedding.ceremony.friends': '朋友 • 同事入場',
    'wedding.ceremony.friends.time': '下午4時30分 ~',
